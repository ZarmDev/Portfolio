  ...
  return (
    <section id="experience">
      <div>
        ...
        <h2>I did the <a href="https://terminal.c1games.com/">Terminal</a> high school competition in 2022</h2>
        <p>Which I lost, but I made a friend and had a lot of fun using Python</p>
        <h2>Code Overflow 2023 Hackathon</h2>
        <pre>
        A 48 hour hackathon where I made a game using Godot.
        </pre>
        <a href="https://www.youtube.com/watch?v=s38TT-4gmsc">Youtube video</a>
        ...
        <a href="">LINK UNAVAILABLE FOR NOW</a>
      </div>
    </section>
  );
}